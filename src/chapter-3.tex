...
\begin{figure}[h]
  \begin{center}
    \subfigure{\includegraphics[width=1\textwidth]{images/ingest-diagram.png}}
  \end{center}
  \label{fig:ingest}
...
\begin{figure}[h]
  \begin{center}
    \subfigure{\includegraphics[width=1\textwidth]{images/tag-diagram.png}}
  \end{center}
  \label{fig:tag}
...
\begin{figure}[h]
  \begin{center}
    \subfigure{\includegraphics[width=1\textwidth]{images/train-diagram.png}}
  \end{center}
  \label{fig:train}
...
\begin{figure}[h]
  \begin{center}
    \subfigure{\includegraphics[width=1\textwidth]{images/predict-diagram.png}}
  \end{center}
  \label{fig:predict}
